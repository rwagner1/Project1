...
global_shortest_path_average.V3 = c(467.2000,455, 453.4000,449.2000,444.6000) #konvergiert nur anfangs schnell und bleibt konstant:(
...
errors.V3 = c(8.3772,9.3690,6.6700,10.6228,6.8508)
...
min_global_shortest_path_average.V3 = c(459,440,440,446,431,435)
...
points(rounds,global_shortest_path_average.V3,cex=0.7,pc=21,bg="green")
